        ...
        while True:
            ...
            if result.multi_hand_landmarks:
                for lms in result.multi_hand_landmarks:
                    ...
                    self.mp_draw.draw_landmarks(frame, lms, self.mp_hands.HAND_CONNECTIONS, connection_drawing_spec=self.mp_draw.DrawingSpec((0, 255, 0), thickness=5, circle_radius=4))
