...
class GestureRecognizer:
    def main(self):
        ...
        self.lock = threading.Lock() #to handle concurrent access to shared data
        self.current_gestures = [] #to store recognized gestures

        #options for the recognizer, check the docs for more
        ...
        #initialize the hands detection, you can play around with these parameters
        ...
        while True:
            ...
            if results.multi_hand_landmarks:
                ...
                self.put_gestures(frame)#displaying recognized gestures in the frame
            cv2.imshow('Gesture Recognition using Mediapipe', frame)#displaying recognized gestures in the frame
